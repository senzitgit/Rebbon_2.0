...
public class RebbonHandler extends HttpServlet{
	...
	public void init(ServletConfig config) throws ServletException {
		...
		recordFeed1 = config.getInitParameter("Feed1");
		recordFeed2 = config.getInitParameter("Feed2");
		recordFeed3 = config.getInitParameter("Feed3");
		recordFeed4 = config.getInitParameter("Feed4");
		recordFeed5 = config.getInitParameter("Feed5");
		recordFeed6 = config.getInitParameter("Feed6");
		recordFeed7 = config.getInitParameter("Feed7");
		recordFeed8 = config.getInitParameter("Feed8");
		...
		if (isMultipart) {
			...
			/*	manageObj.saveRecordings(eviRecordHome, workingDirectory, jsonImage, eventId,
				...
				Properties prop = manageObj.getAvFiles(tempFolder+File.separatorChar+userName,"Temp",userName,
						...
						recordFeed1, recordFeed2, recordFeed3, recordFeed4,
						recordFeed5, recordFeed6, recordFeed7, recordFeed8,"ClazRecords");
				...
				Properties prop = manageObj.getAvFiles(tempFolder+File.separatorChar+userName,"Temp",userName,
						...
						recordFeed1, recordFeed2, recordFeed3, recordFeed4,
						recordFeed5, recordFeed6, recordFeed7, recordFeed8, "CaseRecords");
				JsonParser<String,Properties> jsonResponse = new JsonParser<String,Properties>("GetAvFiles", 1, "Av Files Fetched", "RecordedFeeds", prop);
				jsonResponseText = jsonResponse.JsonResponseText();
			}
				...
				String attachmentPath = "http://"+IpAddressForClient+":"+portNumber+"/Rebbon/CaseRecords/"+caseEventId+"/";
