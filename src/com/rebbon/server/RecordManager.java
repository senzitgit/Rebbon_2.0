...
//        CryptoUtils.decrypt(key, encryptedFile, decryptedFile);
	...
	public Properties getAvFiles(String tempFolderPath,String tempFolderName,String userName,String recordPath,int eventId,String ipAddress,String port,
			String cam1,String cam2,String cam3,String cam4,String mic1,String mic2,String mic3,String mic4,
		...
		*/
		...
		propIn.put("VideoFeed1","http://"+ipAddress+":"+port+"/Rebbon/"+recordFolderName+"/"+eventId+"/"+cam1);
		propIn.put("AudioFeed1","http://"+ipAddress+":"+port+"/Rebbon/"+recordFolderName+"/"+eventId+"/"+mic1);   
		
		propIn.put("VideoFeed2","http://"+ipAddress+":"+port+"/Rebbon/"+recordFolderName+"/"+eventId+"/"+cam2);
		propIn.put("AudioFeed2","http://"+ipAddress+":"+port+"/Rebbon/"+recordFolderName+"/"+eventId+"/"+mic2);   
				 
		propIn.put("VideoFeed3","http://"+ipAddress+":"+port+"/Rebbon/"+recordFolderName+"/"+eventId+"/"+cam3);
		propIn.put("AudioFeed3","http://"+ipAddress+":"+port+"/Rebbon/"+recordFolderName+"/"+eventId+"/"+mic3);   
				
		propIn.put("VideoFeed4","http://"+ipAddress+":"+port+"/Rebbon/"+recordFolderName+"/"+eventId+"/"+cam4);
		propIn.put("AudioFeed4","http://"+ipAddress+":"+port+"/Rebbon/"+recordFolderName+"/"+eventId+"/"+mic4);
